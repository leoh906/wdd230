...
tableButton.addEventListener("click",showTables);
    ...
    function showCards() {
         ...
         function showTables() {
            ...
            divCard.removeChild(itemImage)
            divCard.removeChild(itemName)
            divCard.removeChild(itemAddress)
            divCard.removeChild(itemTelephone)
            divCard.removeChild(itemURL)
            generalListElement.removeChild(divCard)
